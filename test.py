...
# Get password and username from environment variables (hardcoded here for now)
pwd = "demopass"
uid = "etl"
...
def extract():
    try:
        connection_string = 'DRIVER={SQL Server Native Client 11.0};SERVER=localhost\\SQLEXPRESS;DATABASE=AdventureWorksDW2019;Trusted_Connection=yes'
